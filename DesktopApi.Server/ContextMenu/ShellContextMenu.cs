...
namespace DesktopApi.Server.ContextMenu
{
    /// <summary>
    ...
    /// </example>
    public sealed class ShellContextMenu : NativeWindow
    {
        // do poprawy
        #region Constructor
        ...
        internal IntPtr[] GetPIDLs(FileInfo[] arrFI)
        {
        ...
        /// <returns>Array of PIDLs</returns>
        internal IntPtr[] GetPIDLs(DirectoryInfo[] arrFI)
        {
            if (null == arrFI || 0 == arrFI.Length)
            {
                return null;
        ...
        internal void FreePIDLs(IntPtr[] arrPIDLs)
        {
            if (null != arrPIDLs)
            {
        ...
        private void InvokeContextMenuDefault(FileInfo[] arrFI)
        {
            ...
            try
            {
                ...
                uint nDefaultCmd = (uint)NativeMethods.GetMenuDefaultItem(pMenu, false, 0);
        ...
        public static class NativeMethods
        {
            ...
            [DllImport("shlwapi.dll", EntryPoint = "StrRetToBuf", ExactSpelling = false, CharSet = CharSet.Auto, SetLastError = true, BestFitMapping =false, ThrowOnUnmappableChar =true)]
    ...
    {
        internal int HookCode;	// Hook code
        internal IntPtr wParam;	// WPARAM argument
        internal IntPtr lParam;	// LPARAM argument
    }
    #endregion
    ...
    public class LocalWindowsHook
    {
        ...
        // ************************************************************************
        // Internal properties
        internal IntPtr m_hhook = IntPtr.Zero;
        ...
        {
            if (code < 0)
                return (Int32)NativeMethods.CallNextHookEx(m_hhook, code, wParam, lParam);
